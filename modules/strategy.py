...
class Strategy:
    ...
    def create_6_orders(self, arr_l, _zone_150, _zone_100, _zone_75, _zone_50, _zone_25, zone_150, zone_100,
        ...
        logger.info(f'Start creating orders with: {arr_l}, {_zone_150}, {_zone_100}, {_zone_75}, {_zone_50}, {_zone_25}, {zone_150}, {zone_100}, {zone_75}, {zone_50}, {zone_25}, {price}, {POC}')
        delta = 33
        filter_for_enter_to_order = 285
        check_levels = 0
        if check_levels == 0:
            if price - filter_for_enter_to_order > _zone_25 + delta:
            ...
            elif price - filter_for_enter_to_order > _zone_50 + delta:
                ...
                buy_list = [buy_1[0]['result']['order_id'], buy_2[0]['result']['order_id'],
                            buy_3[0]['result']['order_id']]
            elif price - filter_for_enter_to_order > _zone_75 + delta:
                ...
                buy_list = [buy_1[0]['result']['order_id'], buy_2[0]['result']['order_id'],
                            buy_3[0]['result']['order_id']]
            elif price - filter_for_enter_to_order > _zone_100 + delta:
                ...
                buy_list = [buy_1[0]['result']['order_id'], buy_2[0]['result']['order_id'],
                            buy_3[0]['result']['order_id']]
            elif price - filter_for_enter_to_order > _zone_150 + delta:
        ...
        if check_levels == 0:
            if price + filter_for_enter_to_order < zone_25 - delta:
            ...
            elif price + filter_for_enter_to_order < zone_50 - delta:
                ...
                sell_list = [sell_1[0]['result']['order_id'], sell_2[0]['result']['order_id'],
                             sell_3[0]['result']['order_id']]
                return buy_list, sell_list, check_levels
            elif price + filter_for_enter_to_order < zone_75 - delta:
                ...
                sell_list = [sell_1[0]['result']['order_id'], sell_2[0]['result']['order_id'],
                             sell_3[0]['result']['order_id']]
                return buy_list, sell_list, check_levels
            elif price + filter_for_enter_to_order < zone_100 - delta:
                ...
                sell_list = [sell_1[0]['result']['order_id'], sell_2[0]['result']['order_id'],
                             sell_3[0]['result']['order_id']]
                return buy_list, sell_list, check_levels
            elif price + filter_for_enter_to_order < zone_150 - delta:
