    ...
    def create_6_orders(self, arr_l, _zone_150, _zone_100, _zone_75, _zone_50, _zone_25, zone_150, zone_100,
        ...
        if check_levels == 0:
            if price > _zone_25:
                ...
                buy_3 = self.data.create_limit_order("Buy", self.symbol, quantity=2*arr_l, price=_zone_75 - 2*delta, tp=0, sl=(_zone_75 - 2 * delta)-round((_zone_75-_zone_50)/2, 2))
                ...
                buy_3 = self.data.create_limit_order("Buy", self.symbol, quantity=2*arr_l, price=_zone_100 - 2*delta, tp=0, sl=(_zone_100 - 2 * delta)-round((_zone_150-_zone_100)/2, 2))
                ...
                buy_3 = self.data.create_limit_order("Buy", self.symbol, quantity=2*arr_l, price=_zone_150 - 2*delta, tp=0, sl=(_zone_150 - 2 * delta)-round((_zone_150-_zone_100)/2, 2))
