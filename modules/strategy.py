...
class Strategy:
    ...
    def create_2_orders(self, arr_l, arr_s, _zone_150, _zone_100, _zone_75, _zone_50, _zone_25, zone_150, zone_100,
        ...
        if price > _zone_25:
            ...
            self.data.create_limit_order("Buy", self.symbol, arr_l[0], _zone_50, tp=_zone_25,
                                         sl=_zone_50 - delta)
        elif price > _zone_75:
            self.data.create_limit_order("Buy", self.symbol, arr_l[0], _zone_75, tp=_zone_50,
                                         sl=_zone_75 - delta)
        elif price > _zone_100:
            self.data.create_limit_order("Buy", self.symbol, arr_l[0], _zone_100, tp=_zone_75,
                                         sl=_zone_100 - delta)
        elif price > _zone_150:
            self.data.create_limit_order("Buy", self.symbol, arr_l[0], _zone_150, tp=_zone_100,
                                         sl=_zone_150 - delta)
        else:
        ...
        if price < zone_25:
            ...
            self.data.create_limit_order("Sell", self.symbol, arr_s[0], zone_50, tp=zone_25,
                                         sl=zone_50 + delta)
        elif price < zone_75:
            self.data.create_limit_order("Sell", self.symbol, arr_s[0], zone_75, tp=zone_50,
                                         sl=zone_75 + delta)
        elif price < zone_100:
            self.data.create_limit_order("Sell", self.symbol, arr_s[0], zone_100, tp=zone_75,
                                         sl=zone_100 + delta)
        elif price < zone_150:
            self.data.create_limit_order("Sell", self.symbol, arr_s[0], zone_150, tp=zone_100,
                                         sl=zone_150 + delta)
        else:
