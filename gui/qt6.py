# Form implementation generated from reading ui file 'qt6_1419.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.label_19)
        ...
        self.formLayout_2.setLayout(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.horizontalLayout_3)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.trailing_stop)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.label_20)
        ...
        self.formLayout_2.setLayout(10, QtWidgets.QFormLayout.ItemRole.LabelRole, self.horizontalLayout_7)
        self.timer = QtWidgets.QLineEdit(self.centralwidget)
        self.timer.setMaximumSize(QtCore.QSize(74, 16777215))
        self.timer.setObjectName("timer")
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.timer)
        ...
        self.formLayout_2.setLayout(11, QtWidgets.QFormLayout.ItemRole.LabelRole, self.gridLayout)
        self.resetButton = QtWidgets.QPushButton(self.centralwidget)
        self.resetButton.setObjectName("resetButton")
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.ItemRole.FieldRole, self.resetButton)
        self.multorders = QtWidgets.QCheckBox(self.centralwidget)
        self.multorders.setObjectName("multorders")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.multorders)
        self.breakeven = QtWidgets.QCheckBox(self.centralwidget)
        self.breakeven.setObjectName("breakeven")
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.breakeven)
        ...
        self.bot_token = QtWidgets.QLineEdit(self.centralwidget)
        self.bot_token.setMaximumSize(QtCore.QSize(200, 16777215))
        self.bot_token.setObjectName("bot_token")
        self.gridLayout_3.addWidget(self.bot_token, 12, 0, 1, 1)
        self.telegram = QtWidgets.QCheckBox(self.centralwidget)
        self.telegram.setObjectName("telegram")
        self.gridLayout_3.addWidget(self.telegram, 10, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.user_id_label, 13, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.textBrowser, 21, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_9, 20, 0, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem3, 19, 0, 1, 1)
        ...
        self.user_id_value = QtWidgets.QLineEdit(self.centralwidget)
        self.user_id_value.setMaximumSize(QtCore.QSize(200, 16777215))
        self.user_id_value.setObjectName("user_id_value")
        self.gridLayout_3.addWidget(self.user_id_value, 14, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.multorders.setText(_translate("MainWindow", "Multiple orders"))
        self.breakeven.setText(_translate("MainWindow", "Breakeven"))
        self.label_2.setText(_translate("MainWindow", "api key"))
        self.label_3.setText(_translate("MainWindow", "api secret"))
        self.telegram.setText(_translate("MainWindow", "telegram"))
        ...
        self.label_23.setText(_translate("MainWindow", "bot token"))
